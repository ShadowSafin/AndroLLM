...
See [Memory Architecture Deep Dive](docs/memory/memory-architecture.md) for details.
...
See [Voice Assistant Architecture](docs/voice/voice-assistant.md) for details.
