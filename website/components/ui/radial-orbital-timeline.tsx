            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  text-xs font-semibold tracking-wider font-geist
                ...
                {isExpanded && (
                  <Card className="absolute top-20 left-1/2 -translate-x-1/2 w-64 bg-black/90 backdrop-blur-lg border-white/30 shadow-xl shadow-white/10 overflow-visible">
                    ...
                    <CardHeader className="pb-2">
                      ...
                      <CardTitle className="text-sm mt-2 font-geist tracking-tight text-white">
                        {item.title}
                      </CardTitle>
                    </CardHeader>
                    <CardContent className="text-xs text-white/80 font-geist tracking-tight">
                      <p>{item.content}</p>
                      ...
                      {item.relatedIds.length > 0 && (
                        <div className="mt-4 pt-3 border-t border-white/10">
                          <div className="flex items-center mb-2">
                            ...
                            <h4 className="text-xs uppercase tracking-wider font-medium text-white/70 font-geist">
                              Connected Nodes
                            </h4>
                          </div>
                            ...
                            {item.relatedIds.map((relatedId) => {
                              ...
                              return (
                                <Button
                                  ...
                                  variant="outline"
                                  size="sm"
                                  className="flex items-center h-6 px-2 py-0 text-xs rounded-none border-white/20 bg-transparent hover:bg-white/10 text-white/80 hover:text-white transition-all font-geist tracking-tight"
                                  onClick={(e) => {
                                    e.stopPropagation();
