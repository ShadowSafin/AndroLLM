...
function DisplayCard({
  ...
  return (
    ...
    >
      <div>
        <span className="relative inline-block rounded-full bg-white/10 border border-white/10 p-1">
          {icon}
        </span>
        <p className={cn("text-lg font-medium", titleClassName)}>{title}</p>
      </div>
      <p className="whitespace-nowrap text-lg tracking-tight">{description}</p>
