...
export const pillars: Feature[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Automatic health monitoring and provider failover — fallback chain retries before the first token",
      "Robust tool calling — native tools array plus a fallback text parser, with confirmation gates",
      "Cloud Usage Dashboard — tokens, cost estimates, latency, cache performance, CSV export",
      "Prompt caching — provider-aware cache hints with hit/miss and savings diagnostics",
